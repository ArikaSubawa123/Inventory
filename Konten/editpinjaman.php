...
<div class="container">
  <div class="container" style="background: #f5f5f5;">
    <h3 class="pt-2 mb-2">Edit Peminjam</h3>
    <br>
    <form action="aksiubahpinjaman.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="pb-5">
      <input type="hidden" name="idPinjam" value="<?= $r['id_pinjam']; ?>" readonly>
        ...
        <div class="col-md-9">
          <div class="form-group">
            <div class="input-group" id="namebrg">
                <input type="text" class="form-control" placeholder="Peminjam.." aria-label="Peminjam.." aria-describedby="button-addon2" name="peminjm" value="<?= $r['peminjam']; ?>">
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
            <input type="date" class="form-control" placeholder="Date.." aria-label="Date.." aria-describedby="button-addon2" name="tgl_pinjam" value="<?= $r['tgl_pinjam']; ?>">
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
            <input type="number" class="form-control" placeholder="Jumlah Barang.." aria-label="Jumlah Barang.." aria-describedby="button-addon2" name="jmlbrg" value="<?= $r['jml_barang']; ?>">
          </div>
        </div>
      </div>
      <!-- <div class="row">
      ...
      <!-- <div class="row">
        ...
        <div class="col-md-12 text-center">
          ...
          <a href="http://localhost/Inventory/Index.php?p=Pinjaman" class="btn btn-warning">Cancel</a>
        </div>
    </form>
  </div>
</div>