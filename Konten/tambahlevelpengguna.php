...
<div class="container mb-5">
  <div class="container" style="background: #f5f5f5;">
    <h3 class="pt-2 mb-2">Tambah Level Pengguna</h3>
    <br>
    <form action="aksitambahlevelpengguna.php" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="pb-5">
      <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-9">
          <div class="input-group" id="namebrg">
            <input type="number" class="form-control" placeholder="Input Level.." aria-label="Input Level.." aria-describedby="button-addon2" name="lvl">
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Input Deskripsi.." aria-label="Input Deskripsi.." aria-describedby="button-addon2" name="deskripsi">
          </div>
        </div>
      </div>
      <div class="row">
